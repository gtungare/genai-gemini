...
Uses gradio for an interactive chat interface.

Integrates google.generativeai package to interact with the Gemini 1.5 Flash model.

Supports conversation history to maintain context across user inputs.

Provides example prompts for easy testing.

This project implements a chatbot using Gradio and Google Generative AI powered by the gemini-1.5-flash model. The chatbot provides interactive conversations and can respond to user queries dynamically.
